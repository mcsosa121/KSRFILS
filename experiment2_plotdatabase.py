...
plot_with_trend(size_list[inds_sizes],cg_llist[inds_sizes],marker='x',label='cg',color='blue',deg=3)
plot_with_trend(size_list[inds_sizes],deflated_llist[inds_sizes],marker='^',label='deflated',color='orange',deg=3)
plot_with_trend(size_list[inds_sizes],recycled_llist[inds_sizes],marker='o',label='recycled',color='green',deg=3)
plt.yscale('log')
...
plot_with_trend(cond_list[inds_cond],cg_tlist[inds_cond],marker='x',label='cg',color='blue',deg=3)
plot_with_trend(cond_list[inds_cond],deflated_tlist[inds_cond],marker='^',label='deflated',color='orange',deg=3)
plot_with_trend(cond_list[inds_cond],recycled_tlist[inds_cond],marker='o',label='recycled',color='green',deg=3)
plt.yscale('log')
plt.ylabel('Time (ms)')
plt.xscale('log')
...
plot_with_trend(cond_list[inds_cond],cg_llist[inds_cond],marker='x',label='cg',color='blue',deg=3)
plot_with_trend(cond_list[inds_cond],deflated_llist[inds_cond],marker='^',label='deflated',color='orange',deg=3)
plot_with_trend(cond_list[inds_cond],recycled_llist[inds_cond],marker='o',label='recycled',color='green',deg=3)
plt.yscale('log')
plt.ylabel('Number of iterations')
plt.xscale('log')
plt.xlabel('Condition number of matrix')
