...
#plt.plot(size_list[inds_sizes],cg_tlist[inds_sizes],label='cg')
#plt.plot(size_list[inds_sizes],deflated_tlist[inds_sizes],label='deflated')
#plt.plot(size_list[inds_sizes],recycled_tlist[inds_sizes],label='recycled')
plt.ylabel('time')
...
#plt.plot(size_list[inds_sizes],cg_llist[inds_sizes],label='cg')
#plt.plot(size_list[inds_sizes],deflated_llist[inds_sizes],label='deflated')
#plt.plot(size_list[inds_sizes],recycled_llist[inds_sizes],label='recycled')
plt.ylabel('time')
plt.xlabel('size of matrix')
plt.legend()
plt.show()
...
plot_with_trend(cond_list[inds_cond],cg_tlist[inds_cond],marker='x',label='cg',color='blue',deg=6)
plot_with_trend(cond_list[inds_cond],deflated_tlist[inds_cond],marker='^',label='deflated',color='orange',deg=6)
plot_with_trend(cond_list[inds_cond],recycled_tlist[inds_cond],marker='o',label='recycled',color='green',deg=6)
#plt.plot(cond_list[inds_cond],cg_tlist[inds_cond],label='cg')
#plt.plot(cond_list[inds_cond],deflated_tlist[inds_cond],label='deflated')
#plt.plot(cond_list[inds_cond],recycled_tlist[inds_cond],label='recycled')
plt.ylabel('time')
plt.xscale('log')
...
plot_with_trend(cond_list[inds_cond],cg_llist[inds_cond],marker='x',label='cg',color='blue',deg=6)
plot_with_trend(cond_list[inds_cond],deflated_llist[inds_cond],marker='^',label='deflated',color='orange',deg=6)
plot_with_trend(cond_list[inds_cond],recycled_llist[inds_cond],marker='o',label='recycled',color='green',deg=6)
#plt.plot(cond_list[inds_cond],cg_llist[inds_cond],'x',label='cg')
#plt.plot(cond_list[inds_cond],deflated_llist[inds_cond],'^',label='deflated')
#plt.plot(cond_list[inds_cond],recycled_llist[inds_cond],'x',label='recycled')
plt.ylabel('time')
plt.xscale('log')
plt.xlabel('condition number of matrix')
plt.legend()
